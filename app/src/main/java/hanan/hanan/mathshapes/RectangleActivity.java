        ...
        result_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cureentx.length() == 0 && cureenth.length() == 0) {
                    Toast.makeText(RectangleActivity.this, "enter x value and h value", Toast.LENGTH_SHORT).show();
                ...
                } else
                    {
                        ...
                        if (premiter_rb.isChecked()) {
                            ...
                            {
                            Toast.makeText(RectangleActivity.this, "choose between area and perimeter", Toast.LENGTH_SHORT).show();
                        }
                    }
