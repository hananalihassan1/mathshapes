    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        result_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                if (crrentx.length()==0)
                {
                    Toast.makeText(CircleActivity.this,"please enter x value",Toast.LENGTH_SHORT).show();
                }
                else
                {
                    ...
                    }else
                    {
                        ...
                        {
                            Toast.makeText(CircleActivity.this,"choose between area and premiter",Toast.LENGTH_SHORT).show();
                        }
                    }
                }
